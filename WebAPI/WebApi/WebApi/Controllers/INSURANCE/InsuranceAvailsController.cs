...
namespace WebApi.Controllers.INSURANCE
{
    ...
    public class InsuranceAvailsController : ApiController
    {
        ...
        public IHttpActionResult PostInsuranceAvail(InsuranceAvail insuranceAvail)
        {
            ...
            {
                if (InsuranceAvailExists(insuranceAvail.cropid))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = insuranceAvail.cropid }, insuranceAvail);
        }
        ...
        {
            return db.InsuranceAvails.Count(e => e.cropid == id) > 0;
        }
    }
}